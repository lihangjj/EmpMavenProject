                            ...
                            <div class="panel-body" style="height : 95%;">
                                <form action="<%=editEmpUrl%>" id="myform" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="form-group" id="emp.nameDiv">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="emp.ename" id="emp.ename"
                                        ...
                                        <div class="col-md-5">
                                            <select id="emp.deptno" name="emp.deptno" class="form-control">
                                                <c:forEach items="${allDept}" var="de">
                                                    <option value="${de.deptno}" ${de.deptno==dept.deptno?"selected":""}
                                                    >${de.dname}&nbsp&nbsp(剩余名额：${de.maxnum-de.currnum})</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group" id="emp.jobDiv">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="emp.job" id="emp.job" class="form-control input-sm"
                                                   value="${emp.job}" placeholder="请输入雇员职位">
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <select id="emp.lid" name="emp.lid" class="form-control">
                                                <c:forEach items="${allLevel}" var="lev">
                                                    <option value="${lev.lid}" ${lev.lid==level.lid?"selected":""}>${lev.title}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group" id="emp.salDiv">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="emp.sal" id="emp.sal" class="form-control input-sm"
                                                   value="${emp.sal}" placeholder="请输入雇员基本工资，工资要与员工等级匹配">
                                        </div>
                                    ...
                                    <div class="form-group" id="emp.commDiv">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="emp.comm" id="emp.comm"
                                                   class="form-control input-sm"
                                                   value="${emp.comm}" placeholder="如果为销售人员，设置每月佣金">
                                        </div>
                                    ...
                                    <div class="form-group" id="emp.photoDiv" >
                                        ...
                                        <div class="col-md-5">
                                            <input type="file" name="photo" id="photo"
                                                   class="form-control input-sm" placeholder="请上传员工照片">
                                        </div>
                                    ...
                                    <div class="form-group" id="photoDiv" >
                                        ...
                                        <div class="col-md-2"style="text-align: left">
                                            <img src="/upload/emp/${emp.photo}"  width="150px">
                                        </div>
                                    </div>
                                    <div class="form-group" id="member.noteDiv">
                                        <label class="col-md-2 control-label" for="note">员工简介：</label>
                                        <div class="col-md-5">
                                            <textarea rows="6" name="note" id="note" class="form-control input-sm"
                                                      placeholder="将员工基本信息进行简要描述"></textarea>
                                        </div>
                                    ...
                                    <input type="hidden" name="emp.flag" value="${emp.flag}">
                                    <input type="hidden" value="${emp.photo}" name="emp.photo">
                                    <input type="hidden" name="emp.mid" value="${emp.mid}">
                                    <input type="hidden" name="emp.empno" value="${emp.empno}">
                                    <input type="hidden" name="emp.hiredate" value="${emp.hiredate}">
                                </form>
                            </div>
                        </div>
                    </div>
