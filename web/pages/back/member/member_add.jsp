                            ...
                            <div class="panel-body" style="height : 95%;">
                                <form action="<%=addMemberUrl%>" id="myform" method="post" class="form-horizontal">
                                    <div class="form-group" id="member.midDiv">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="member.mid" id="member.mid"
                                                   class="form-control input-sm" placeholder="请输入登陆账号">
                                        </div>
                                    ...
                                    <div class="form-group" id="member.passwordDiv">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="member.password" id="member.password"
                                                   class="form-control input-sm" placeholder="请输入登陆密码">
                                        </div>
                                        <div class="col-md-4" id="member.passwordMsg">*</div>
                                    </div>
                                    <div class="form-group" id="passwordAginDiv">
                                        <label class="col-md-2 control-label" for="passwordAgin">确认密码：</label>
                                        <div class="col-md-5">
                                            <input type="text" name="passwordAgin" id="passwordAgin"
                                                   class="form-control input-sm" placeholder="请再次确认登陆密码">
                                        </div>
                                        <div class="col-md-4" id="passwordAginMsg">*</div>
                                    </div>
                                    ...
                                    <input type="hidden" id="member.sflag" name="member.sflag" value="0">
